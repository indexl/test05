...
import com.example.demo.dao.BookStoreRepository;
...
class Exam1ApplicationTests {
	...
	@Test
	void t4() {
	bookStoreRepository.modifyStore(2, "IT문고");
	...
	@Test
	void t7() {
		List<BookVO> books = bookRepository.selectBookStoreKorea("코리아서점");
		
		System.out.println("==코리아서점의 책의 정보==");
		for(int i = 0; i < books.size(); i++) {
			BookVO book = books.get(i);
